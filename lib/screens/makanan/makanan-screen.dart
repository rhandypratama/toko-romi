...
class MakananScreen extends StatefulWidget {
  @override
  _MakananScreenState createState() => _MakananScreenState();
}
          ...
          children: <Widget>[
            Padding(
              ...
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: <Widget>[
                  dynamicText("Makanan & Minuman", fontWeight: FontWeight.w600, fontSize: 20),
                  dynamicText("Tetap awali #DiRumahAja dengan penuhi gizimu", fontSize: 12),
